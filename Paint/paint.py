...
def info_alumnos():
    ...
    t.goto(0,190)
    t.color('blue')
    t.write('Cristian Alejandro Garcia Mendoza', align='left', font=('Arial', 10, 'normal'))
    t.goto(0,170)
    t.color('pink')
    t.write('Cesar Alejandro Benavides ', align='left', font=('Arial', 10, 'normal'))
    t.goto(0,150)
    t.color('green')
    t.write('Rodrigo Ibarra ', align='left', font=('Arial', 10, 'normal'))
